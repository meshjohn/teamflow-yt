    ...
    <Popover onOpenChange={handleOpenChange} open={open}>
      <PopoverTrigger asChild>
        <Button
          type="button"
          size="sm"
          className="relative overflow-hidden rounded-full bg-gradient-to-t from-violet-600 to-fuchsia-600 text-white shadow-md hover:shadow-l focus-visible:ring-2 focus-visible:ring-ring"
        >
      ...
      <PopoverContent className="w-[25rem] p-0" align="end">
        ...
        <div className="flex items-center justify-end gap-4 border-t px-3 py-2 bg-muted/30">
          <Button
            type="submit"
            size="sm"
            variant="outline"
